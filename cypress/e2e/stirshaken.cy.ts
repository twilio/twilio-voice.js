  ...
  describe('device 1 calls device 2', () => {
    ...
    describe('with pstream sending additional params', () => {
      ...
      before(() => new Promise<void>(async resolve => {
        ...
        const transport = devShim._stream._pstream.transport;
        transport.__onSocketMessage = transport._onSocketMessage;
        transport._onSocketMessage = (message: any) => {
          ...
          return transport.__onSocketMessage(message);
        };
