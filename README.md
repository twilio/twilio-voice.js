...
["Tags"](https://github.com/twilio/twilio-voice.js/tags) and find the most recently tagged release, or
...
> version, you should not use a release tagged with "-rc" in the name.
