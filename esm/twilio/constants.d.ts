...
declare const RELEASE_VERSION = "2.17.0-rc1";
declare const SOUNDS_BASE_URL = "https://sdk.twilio.com/js/client/sounds/releases/1.0.0";
declare const COWBELL_AUDIO_URL = "https://sdk.twilio.com/js/client/sounds/releases/1.0.0/cowbell.mp3?cache=2.17.0-rc1";
